...
from numpy import inf, sign, dot, diag, array, cumsum, sort, sum, searchsorted, newaxis, arange, sqrt, log2, log, power, ceil, prod, zeros, concatenate
...
def E(I, theta_motif, theta_background_matrix, lambda_motif):
    Z_and_elogL = [[Z0_I(Iij,theta_motif, theta_background_matrix,lambda_motif) for Iij in Ii] for Ii in I]
    Z = [[xij[0] for xij in xi] for xi in Z_and_elogL] 
    elogL = [[xij[1] for xij in xi] for xi in Z_and_elogL]
    expected_LogLikelihood = sum(chain.from_iterable(elogL))
...
def EM(I, n, theta_motif, theta_background_matrix, lambda_motif, TOL=1E-6, MAXITER=1000):
    ...
    for k in xrange(MAXITER):
        ...
        #E-step
        Z, c0, c, expected_logLikelihood = E(I, theta_motif, theta_background_matrix, lambda_motif)
        #M-step
        lambda_motif, theta_motif, theta_background_matrix = M(Z, n, c0, c)
    ...
    for i in range(NPASSES):#search for NPASSES of motifs of width W
        ...
        for lambda0 in lambda0s:
            ...
            for sampledI in sampledIndicators:
                ...
                #E-step
                Z, c0, c, expected_logLikelihood = E(I, theta_motif_guess, theta_uniform_background_matrix, lambda0)
                #M-step
                ...
                Z, c0, c, expected_logLikelihood = E(I, theta_motif_updated, theta_background_matrix_updated, lambda_motif_updated)
            ...
            lambda_motif, theta_motif, theta_background_matrix = EM(I, n, theta_motif, theta_background_matrix, lambda_motif)
