...
fractions
"""
def extreme(Y,Kmin,Kmax,Wmin,Wmax,best_word,ethresh,rthresh,tries=10,fudgefactor=1.0,revcomp=True):
    ...
    for npass in range(1):
        ...
        distanceses = list()
        logevs = list()
        print 'Padding both sides of RE with 4 Ns'
        best_word = 'NNNN' + best_word + 'NNNN'
...
def main():
    ...
    tries = args.tries
    theta_motifs, theta_background_matrices, lambda_motifs, fractionses, distanceses, logevs, disc_pwms, disc_logevs = extreme(seqs,mink,maxk,minw,maxw,best_word,ethresh,rthresh,tries,fudgefactor)
    k = 1
